...
class HMC(Algorithm):
    ...
    def __leapfrog_step(self, old_theta, r, dt, grad_theta=None):
        ...
        # Optimization: Use cached grad_theta from the previous leapfrog step if available
        # This saves one gradient evaluation per leapfrog step, significantly speeding up HMC
