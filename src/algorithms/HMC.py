...
class HMC(Algorithm):
    ...
    def __leapfrog_step(self, old_theta, r, grad_theta, dt):
        """ Performs one leap-frog step starting from previous values of theta/sigma, r/s, and previous gradient """
        r = r - grad_theta * dt / 2
    ...
    def sample_theta(self, theta_0):
        ...
        for _ in range(self.HMC_L):
            theta, r, grad_theta = self.__leapfrog_step(theta, r, grad_theta, self.HMC_dt)
