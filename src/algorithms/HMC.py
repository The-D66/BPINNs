...
class HMC(Algorithm):
    ...
    def sample_theta(self, theta_0):
        ...
        # ⚡ Bolt Optimization: Cache initial gradient to avoid computing it twice per leapfrog step.
        # This reduces grad_loss evaluations from 2*HMC_L to HMC_L + 1 per sample.
        self.model.nn_params = theta
        grad_theta = self.model.grad_loss(self.data_batch, self.__full_loss)
