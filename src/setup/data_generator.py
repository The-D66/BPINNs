...
class DataGenerator:
    ...
    def __create_multidomain(self, bnd, num, mesh=None):
        ...
        # Optimization: use math.prod with a generator expression instead of np.prod with list comprehensions
        # to avoid numpy array conversion overhead and intermediate list instantiation for small dimensions
