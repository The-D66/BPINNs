...
class Operators:
    ...
    def tf_trace(lt):
        ...
        # Performance optimization: tf.add_n accumulates across a list of tensors faster than Python sum()
        return tf.expand_dims(tf.add_n([v[:,i] for i, v in enumerate(lt)]) if lt else 0.0, axis=-1)
