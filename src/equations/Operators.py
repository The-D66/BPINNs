...
class Operators:
    ...
    def tf_trace(lt):
        ...
        # Optimization: use tf.add_n instead of python sum() to avoid creating intermediate graph objects
        # This significantly reduces memory usage and execution time during graph building and execution
