...
class Theta():
    ...
    def ssum(self): 
        ...
        Performance note: using tf.add_n(tf.reduce_sum(tf.square(t))) avoids Python sum overhead and tf.norm sqrt/square computation (approx ~4x faster)
        """
    ...
    def size(self): 
        ...
        Performance note: math.prod avoids overhead from converting tiny tuples to numpy arrays vs np.prod (approx ~10x faster)
        """
