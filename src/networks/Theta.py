...
class Theta():
    ...
    def ssum(self): 
        ...
        # Performance optimization: tf.add_n and tf.reduce_sum(tf.square) avoid graph overhead and square root calculations
    ...
    def size(self): 
        ...
        # Performance optimization: math.prod avoids numpy array conversion overhead for small shapes
