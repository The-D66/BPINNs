...
class Theta():
    ...
    def ssum(self): 
        ...
        # Performance optimization: tf.add_n avoids excessive eager tensor creation overhead vs sum().
        # tf.reduce_sum(tf.square(t)) avoids the compute-heavy square root in tf.norm(t)**2.
    ...
    def size(self): 
        ...
        # Performance optimization: math.prod avoids NumPy conversion overhead for small shape tuples.
