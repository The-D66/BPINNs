...
class Theta():
    ...
    def ssum(self): 
        ...
        # Bolt Performance Improvement: Replaced tf.norm(t)**2 and Python's sum()
        # with tf.add_n and tf.reduce_sum(tf.square(t)). This avoids a costly
        # square root calculation, prevents undefined gradients near zero,
        # and builds a more efficient graph.
    ...
    def size(self): 
        ...
        # Bolt Performance Improvement: Replaced np.prod with math.prod
        # to avoid unnecessary NumPy type conversion overhead for small shape tuples.
