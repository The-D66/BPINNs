...
class LossNN(PhysNN):
    ...
    def metric_total(self, dataset, full_loss = True):
        ...
        # Optimization: use tf.add_n instead of sum() for better graph performance, fallback to 0.0 if empty
    ...
    def loss_total(self, dataset, full_loss = True):
        ...
        # Optimization: use tf.add_n instead of sum() for better graph performance
